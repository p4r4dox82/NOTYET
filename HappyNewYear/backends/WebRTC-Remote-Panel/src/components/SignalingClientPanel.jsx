...
function SignalingClientPanel(props) {
	...
	return (
		<div className="signalingCleintPanel_main">
			<Container className="signalingCleintPanel_function" id="tdSignaling" style={componentStyle}>
			...
			<div className="signalingCleintPanel_display">
				{
					// List out Websocket clients and add handlers to bind them to a Web RTC session
					clients.map((wsClient, i) => {
						const { id, address, properties } = wsClient;
